...
export interface ResponseEventOverTimeLv2Fail extends ajaxPB.AjaxSubmit
{
...
export interface ResponseEventOverTimeLv2Catch extends ajaxPB.AjaxSubmit
{
    /** 回應事件 程序 Fail */
...
export interface ResponseEventOverTimeLv2Finally extends ajaxPB.AjaxSubmit
{
    /** 回應事件 程序 Fail */
