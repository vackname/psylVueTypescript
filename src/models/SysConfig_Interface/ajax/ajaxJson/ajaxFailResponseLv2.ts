...
/** 回應事件 Fail LV2 Catch */
export interface ResponseEventFailLv2Catch extends ajaxPB.AjaxJsonSubmit
{
...
export interface ResponseEventFailLv2Finally extends ajaxPB.AjaxJsonSubmit
{
...
export interface ResponseEventFailLv2OverTime extends ajaxPB.AjaxJsonSubmit
{
    /** 回應事件 Request/Process 錯誤資訊*/
