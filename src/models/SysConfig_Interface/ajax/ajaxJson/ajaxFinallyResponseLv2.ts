...
export interface ResponseEventFinallyLv2Fail extends ajaxPB.AjaxJsonSubmit
{    
...
export interface ResponseEventFinallyLv2Catch extends ajaxPB.AjaxJsonSubmit
{
    /** 回應事件 程序 Fail */
...
export interface ResponseEventFinallyLv2OverTime extends ajaxPB.AjaxJsonSubmit
{
    /** 回應事件 程序 Fail */
