...
/** 回應事件 Catch LV2 Fail */
export interface ResponseEventCatchLv2Fail extends ajaxPB.AjaxJsonSubmit
{
...
export interface ResponseEventCatchLv2Finally extends ajaxPB.AjaxJsonSubmit
{
    /** 回應事件 程序 Fail */
...
export interface ResponseEventCatchLv2OverTime extends ajaxPB.AjaxJsonSubmit
{
    /** 回應事件 程序 Fail */
