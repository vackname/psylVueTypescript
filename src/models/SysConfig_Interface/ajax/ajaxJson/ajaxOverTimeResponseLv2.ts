...
export interface ResponseEventOverTimeLv2Fail extends ajaxPB.AjaxJsonSubmit
{
...
export interface ResponseEventOverTimeLv2Catch extends ajaxPB.AjaxJsonSubmit
{
    /** 回應事件 程序 Fail */
...
export interface ResponseEventOverTimeLv2Finally extends ajaxPB.AjaxJsonSubmit
{
    /** 回應事件 程序 Fail */
