...
import ResponseEventFail from './ajaxFileStream/ajaxFailResponse';
import ResponseEventCatch from './ajaxFileStream/ajaxCatchResponse';
import ResponseEventFinally from './ajaxFileStream/ajaxFinallyResponse';
import ResponseEventOverTime from './ajaxFileStream/ajaxOverTimeResponse';
 ...
 * 僅限 get 使用
*/
export default interface ajaxThen extends ajaxPB.AjaxFileStreamSubmit
{
