...
/** 回應事件 Fail LV2 Catch */
export interface ResponseEventFailLv2Catch extends ajaxPB.AjaxSubmit
{
...
export interface ResponseEventFailLv2Finally extends ajaxPB.AjaxSubmit
{
...
export interface ResponseEventFailLv2OverTime extends ajaxPB.AjaxSubmit
{
    /** 回應事件 Request/Process 錯誤資訊*/
