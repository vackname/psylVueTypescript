...
export interface ResponseEventFinallyLv2Fail extends ajaxPB.AjaxSubmit
{    
...
export interface ResponseEventFinallyLv2Catch extends ajaxPB.AjaxSubmit
{
    /** 回應事件 程序 Fail */
...
export interface ResponseEventFinallyLv2OverTime extends ajaxPB.AjaxSubmit
{
    /** 回應事件 程序 Fail */
