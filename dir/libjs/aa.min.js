...
},[vToYWE_Model.view_userset,'H4sIAAAAAAAAA4uOBQApu0wNAgAAAA=='],'userset','aa');
},'aa_view_userset','aa/c2.css'); 
 split_b_obj.c_sID(this,'view_index','aatemp/t2',false,true,function(){ 
 this.vue=null;split_b_obj.c_JS(this,selfPJ,function(){

},[vToYWE_Model.view_index,'H4sIAAAAAAAAA4uOBQApu0wNAgAAAA=='],'index','aa');
},'aa_view_index','aa/c1.css'); 
 split_b_obj.c_sID(this,'view_asyncLoadView','aatemp/t1',false,true,function(){ 
 this.vue=null;split_b_obj.c_JS(this,selfPJ,function(){

},[vToYWE_Model.view_asyncLoadView,'H4sIAAAAAAAAA4uOBQApu0wNAgAAAA=='],'asyncLoadView','aa');
...
var PJVueModel = (function () {
    ...
    define("src/aa/model/asyncM/item1model", ["require", "exports"], function (require, exports) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        /** temp this */
        var $t;
    ...
    define("src/aa/model/asyncM/main", ["require", "exports", "src/aa/model/asyncM/item1model"], function (require, exports, item1model_1) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
    ...
    define("src/aa/view/asyncLoadView", ["require", "exports", "src/models/SysConfig_Interface/tscModel/aa"], function (require, exports, aa_1) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
    ...
    define("src/aa/view/index", ["require", "exports", "src/models/vueSDK"], function (require, exports, vueSDK_2) {
        ...
        (function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, vueSDK_2.sleep)(3000)];
                    case 1:
                        _a.sent();
        ...
        vueSDK_2.ajax.Form.Delete("/testUrl").InputUrlIDForString("dda").InputUrlIDForNumber(127283).head({ "a": 1 })
            .OverTimeEvent(1000, function (errMes) {
        }).toResponse(function (e) {
        }).ContinueWith({
            SuccessEvent: function (valObj) {
                var obj = vueSDK_2.ajax.Form.Get("https://api64.ipify.org").head({}).input({ format: "json", callback: "toPsylIP6" })
                    .toSubmit()
                    .ContinueWith({
                    SuccessEvent: function (valObj2) {
                        valObj.resolve(valObj2.ObjectVal);
                        var objTask = vueSDK_2.task.Factory.StartNew(function (valobj3) {
                            setTimeout(function () {
                                valobj3.resolve("vva obj");
                            }, 4000);
                        });
                        objTask.ContinueCatch(function (rjVal) {
                        }).AbortAfter(3000);
                        var MultipleObj = vueSDK_2.task.Factory.StartNewMultipleToFirst([objTask, vueSDK_2.task.Factory.StartNew(function (valobj3) {
                                setTimeout(function () { valobj3.resolve("vva Array 2"); }, 2000);
                            }), vueSDK_2.task.Factory.StartNew(function (valobj3) {
                                setTimeout(function () { valobj3.resolve("vva Array 3"); }, 5000);
                            })]).ContinueWith({
                            SuccessEvent: function (valObj) {
                                console.log(valObj.ObjectVal);
                            }
                        }); //多個 task 取第一個 Event事件
                        var objTask2 = vueSDK_2.task.Factory.StartNew(function (valobj3) {
                            setTimeout(function () {
                    ...
                    CatchEvent: function (valObj2) {
                    }
                });
                obj.ContinueCatch(function (rjVal) {
                    valObj.reject(rjVal);
                });
                return obj;
            }
        }).ContinueCatch(function (rjVal) {
            //error
        }).AbortAfter(3000);
        var ajaxObj1 = vueSDK_2.ajax.Form.Get("https://api64.ipify.org").head({}).input({ format: "json", callback: "toPsylIP6" })
            .OverTimeEvent(1000, function (e) {
        ...
        setTimeout(function () {
            ajaxObj1.toSubmit().ContinueWith({
                SuccessEvent: function (val) {
                    console.log("setTimeout awaitCatch");
                    console.log(val.ObjectVal);
                    return ajaxObj1.toStringResponse(function (res) {
                    });
                }
            });
        }, 3000);
        ajaxObj1.toResponse(function (e) {
        }).ContinueWith({
            SuccessEvent: function (val) {
                console.log("awaitThen");
                console.log(val.ObjectVal);
                ajaxObj1.toStringResponse(function (res) {
                    val.resolve("OK");
                }).ContinueCatch(function (rjVal) {
                    val.reject(rjVal);
                });
        ...
        var toRun = true;
        var toRun2 = true;
        new Promise(function (rv, rj) {
            return new Promise(function (rv, rj) {
            }).then(function (rvVal) {
            }).catch(function (rjVal) {
            });
        });
        var toTask = vueSDK_2.task.Factory.StartNew(function (valObj) {
            valObj.resolve("HIHI Task");
        }).ContinueWith({
            SuccessEvent: function (valObj) {
                valObj.ObjectVal;
                console.log(valObj.ObjectVal);
                setTimeout(function () { valObj.resolve("setTimeOut 1s"); }, 1000);
            },
        }).ContinueWith({
            SuccessEvent: function (valObj) {
                console.log(valObj.ObjectVal);
                setTimeout(function () { valObj.resolve("setTimeOut 2s"); }, 2000);
            }
        }).ContinueWith({
            SuccessEvent: function (valObj) {
                console.log(valObj.ObjectVal);
                ((toRun) ? valObj.resolve("then true") : valObj.reject("then false"));
                var toTask2 = vueSDK_2.task.Factory.StartNew(function (valObj) {
                    valObj.resolve("HIHI Task _2");
                }).ContinueWith({
                    SuccessEvent: function (val) {
                        setTimeout(function () { valObj.resolve("setTimeOut 1s _2"); }, 1000);
                    },
                    CatchEvent: function (val) {
                    }
                }).ContinueWith({
                    SuccessEvent: function (valObj) {
                        console.log(valObj.ObjectVal);
                        setTimeout(function () { valObj.resolve("setTimeOut 2s _2"); }, 2000);
                        toTask.Abort();
                    }
                }).ContinueWith({
                    SuccessEvent: function (valObj) {
                    ...
                    SuccessEvent: function (valObj) {
                        console.log(valObj.ObjectVal);
                        setTimeout(function () { valObj.resolve("setTimeOut 3s _2"); }, 3000);
                    }
                }).ContinueWith({
                    SuccessEvent: function (valObj) {
                        console.log(valObj.ObjectVal);
                        setTimeout(function () {
                            return ((toRun2) ? valObj.resolve("then2 true _2") : valObj.reject("then2 false _2"));
                        }, 1000);
                    }
                });
                return toTask2;
            ...
            .ContinueWith({
            SuccessEvent: function (valObj) {
                setTimeout(function () { valObj.resolve("setTimeOut 3s"); }, 3000);
            }
        }).ContinueWith({
            SuccessEvent: function (valObj) {
                console.log(valObj.ObjectVal);
                setTimeout(function () {
                    return ((toRun2) ? valObj.resolve("then2 true") : valObj.reject("then2 false"));
                }, 1000);
            }
        });
        console.log(toTask.getPromise());
        toTask.ContinueCatch(function (rjVal) {
            console.error("取得錯誤");
            console.error(rjVal);
        }).AbortAfter(7100);
        setTimeout(function () {
    ...
    define("src/aa/controllers/asyncLoadView", ["require", "exports", "src/models/SysConfig_Interface/tscModel/aa"], function (require, exports, aa_2) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        ...
        exports.default = {
            ...
            discreteModelLoad: function (tsc) { return tsc(new aa_2.default())
            ...
            temp: function ($t) {
                ...
                return {
                    view1: $t.import.url('@view/index')
                        .exportVue({
                        aaProject_main: { layout: 'hi(layout)' },
                        datamain: $t.maindata
                    })
                };
            },
    ...
    define("psylbundletscView/aa_MapSorce", ["require", "exports", "src/aa/view/asyncLoadView", "src/aa/view/index", "src/aa/view/userset", "src/aa/controllers/asyncLoadView", "src/aa/controllers/index", "src/aa/controllers/userset", "src/aa/main"], function (require, exports, asyncLoadView_1, index_2, userset_1, asyncLoadView_2, index_3, userset_2, main_1) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        ...
        exports.default = { view_asyncLoadView: asyncLoadView_1.default, view_index: index_2.default, view_userset: userset_1.default, controllers_asyncLoadView: asyncLoadView_2.default, controllers_index: index_3.default, controllers_userset: userset_2.default, main: main_1.default };
    });
...
split_b_obj.p(this,'aatemp/t0',false,function(){
 this.vue=null;split_b_obj.pv(this,vToYWE_Model,'H4sIAAAAAAAAA4uOBQApu0wNAgAAAA==',function(){},'aa'); 
},'aa','I2FhX21haW57CiAgICAgICAgICAgICAgICBiYWNrZ3JvdW5kLWNvbG9yOiM1NTU7CiAgICAgICAgICAgICAgICBjb2xvcjojRkZGOwogICAgICAgIH0='); 
