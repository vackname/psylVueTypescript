...
return self;
 ...
 this.pjAPI['controllers_asyncLoadView'] = function($t){ var self = this; 
   pb.AddPrototype(self,vToYWE_Model.controllers_asyncLoadView); 
return self;
 }; 
...
this.vue=vToYWE_Model.view_userset; 
 ...
 this.view_userset = function(){ var runCreateVue = new VueChild().html(importLoad.root+'aatemp/t3').export(new view_userset_vueclass());runCreateVue.styleID = 'aa_view_userset'; runCreateVue.styleurl(importLoad.root+'aa/c2.css'); return runCreateVue; 
 }; 
...
this.vue=vToYWE_Model.view_index; 
 ...
 this.view_index = function(){ var runCreateVue = new VueChild().html(importLoad.root+'aatemp/t2').export(new view_index_vueclass());runCreateVue.styleID = 'aa_view_index'; runCreateVue.styleurl(importLoad.root+'aa/c1.css'); return runCreateVue; 
 }; 
 
 function view_asyncLoadView_vueclass(){ 
 (function(){

})()
this.vue=vToYWE_Model.view_asyncLoadView; 
 new oderLoad(selfPJ.pjAPI).Co(this,selfPJ.pjAPI.controllers_asyncLoadView,'aa/');
} 
 this.view_asyncLoadView = function(){ var runCreateVue = new VueChild().html(importLoad.root+'aatemp/t1').export(new view_asyncLoadView_vueclass());runCreateVue.styleID = 'aa_view_asyncLoadView'; runCreateVue.styleurl(importLoad.root+'aa/c0.css'); return runCreateVue; 
 }; 
    ...
    define("src/aa/view/index", ["require", "exports", "src/models/vueSDK"], function (require, exports, vueSDK_2) {
        ...
        exports.default = {
            ...
            init: function ($t) {
                ...
                setTimeout(function () {
                    $t.show = true;
                    vueSDK_2.pb.el.id("aa_index_closBt") //close userset.html button
                        .frame(function ($t) { return $t.animate({ "duration": 1, "delay": 1, "count": 1 }, {
