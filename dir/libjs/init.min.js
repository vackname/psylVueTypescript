...
var PJVueModel = (function () {
    ...
    define("src/models/SysConfig_Interface/psylVueTsc", ["require", "exports", "src/models/SysConfig_Interface/ProjectMap/init_View", "src/models/SysConfig_Interface/vueDirectiveEvt"], function (require, exports, init_View_2, vueDirectiveEvt_1) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
    ...
    define("src/init/main", ["require", "exports", "src/models/vueSDK", "src/models/SysConfig_Interface/psylVueTsc"], function (require, exports, vueSDK_4, psylVueTsc_1) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        ...
        new psylVueTsc_1.default(function (temp) { return temp.view_index; })
            ...
            .getIcon(function ($t) {
            return vueSDK_4.importLoad.pub.lib.src('inlayout.ico');
        })
            .getHeadTitle("init.page", //資料切換觸發 key
        function ($t) {
            return vueSDK_4.importLoad.pub.config.get("title") + "-" + vueSDK_4.importLoad.pub.config.get("page")[$t.init.page];
        }) //html title name
            .load(function ($t) {
            return {
                main: $t //注入共用入口點數據(繼承)
