...
this.vue['getJson'] = JSON.parse(pb.zu('H4sIAAAAAAAAA6tWAAKl1Dwlq2oFKFDy8PTwVLJS8vdWAnFrdcCCyRlYlDxduheiphYArGxg/kgAAAA=')); 
 new oderLoad(selfPJ.pjAPI).Co(this,selfPJ.pjAPI.controllers_index,'init/');
} 
 this.view_index = function(){ var runCreateVue = new VueChild().html(importLoad.root+'inittemp/t3').export(new view_index_vueclass());runCreateVue.styleID = 'init_view_index'; runCreateVue.styleurl(importLoad.root+'init/c2.css'); return runCreateVue; 
 }; 
