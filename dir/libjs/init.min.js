...
var PJVueModel = (function () {
    ...
    define("src/init/view/index", ["require", "exports", "src/init/animateModel/author", "src/models/vueSDK"], function (require, exports, author_1, vueSDK_2) {
        ...
        exports.default = {
            ...
            completed: function ($t, tscModel) {
                ...
                $t.authorImg = (0, vueSDK_2.jObj)(); //啟用注入jObj 物件
                $t.authorImg.loadlib("author", function (e) {
    ...
    define("src/models/SysConfig_Interface/vueDirectiveEvt", ["require", "exports"], function (require, exports) {
        ...
        var vueDirectiveEvt = /** @class */ (function () {
            function vueDirectiveEvt() {
                 ...
                 */
                this.bind = function (command, fun) { return addDvFun(command, 'bind', fun); };
                /** 初始綁定元素插入父節點調用 (注入於元素 ex: v-foucs)
                 * @param command 指令名(需為 lowercase)
                 * @param fun 調用 function
                 */
                this.inserted = function (command, fun) { return addDvFun(command, 'inserted', ((fun != null && fun != undefined) ? fun : function () { })); };
                /** 被綁定元素所在的模板更新時調用 (可以忽略不必要的模板更新) ex v-foot:aa.dd.cc='okFunction()'
                 * @param command 指令名(需為 lowercase)
                 * @param fun 調用 function
                 */
                this.update = function (command, fun) { return addDvFun(command, 'update', fun); };
                /** 被綁定元素所在模版完成一次更新周期調用 ex v-foot:aa.dd.cc='okFunction()'
                 * @param command 指令名(需為 lowercase)
                 * @param fun 調用 function
                 */
                this.componentUpdated = function (command, fun) { return addDvFun(command, 'componentUpdated', fun); };
                /** 只調用一次，指令與元素解綁時機調用 ex v-foot:aa.dd.cc='okFunction()'
                 * @param command 指令名(需為 lowercase)
                 * @param fun 調用 function
                 */
                this.unbind = function (command, fun) { return addDvFun(command, 'unbind', fun); };
            }
        ...
        var CreateVue = /** @class */ (function () {
            ...
            */
            function CreateVue(temp) {
                var _this = this;
                /** add 自定義指令 */
                this.addCommand = function (fun) {
                    fun(new vueDirectiveEvt_1.default());
                    return _this;
                };
                /**
                 * app 樣版數據物件
    ...
    define("src/init/main", ["require", "exports", "src/models/vueSDK", "src/models/SysConfig_Interface/psylVueTsc"], function (require, exports, vueSDK_3, psylVueTsc_1) {
        ...
        new psylVueTsc_1.default(function (temp) { return temp.view_index; })
            .addCommand(function (dir) { return dir.inserted("focus", function (el, binding) {
            ...
            .addCommand(function (dir) { return dir.bind("desbind", //html 觸發調用一次
        function (el, binding, vnode) {
            ...
            .addCommand(function (dir) { return dir.update("upm", //value 被觸發變動
