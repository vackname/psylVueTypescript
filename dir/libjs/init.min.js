...
var PJVueModel = (function () {
    ...
    define("src/init/animateModel/author", ["require", "exports", "src/models/vueSDK"], function (require, exports, vueSDK_1) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        /** 作者動畫 */
    ...
    define("src/init/temp/index/AuthorAnimate", ["require", "exports", "src/models/vueSDK", "src/init/animateModel/author"], function (require, exports, vueSDK_2, author_1) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        ...
        exports.default = {
            ...
            completed: function ($t) {
                vueSDK_2.task.Factory.StartNew(function (val) {
                    var authorImg = (0, vueSDK_2.jObj)(); //啟用注入jObj 物件
    ...
    define("src/init/view/index", ["require", "exports", "src/models/vueSDK"], function (require, exports, vueSDK_3) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        /** 首頁-入口Body Temp */
        exports.default = {
            ...
            completed: function ($t) {
                $t.import.p.aa(function (InsertTemp) {
                    return InsertTemp("aaTemp", function (tempObj) { return tempObj; }).toLoad();
                });
                //樣版渲染完成
                vueSDK_3.pb.el.id("init_panel").style({ "opacity": "0" }).animate({ "duration": 0.6, "delay": 0.3, "count": 1 }, {
                    "0%": { "opacity": "0.1" },
                    "100%": { "opacity": "1" }
                }).remove();
                if ($t.main != null)
            ...
            temp: function ($t) {
                /** 樣版緩存 */
                var tempObj = {};
                vueSDK_3.pb.AddPrototype($t.head, { main: $t });
                tempObj["headTemp"] = (0, vueSDK_3.Component)($t).import(function (temp) { return temp.init.temp_index_head; }).exportVue($t.head);
                tempObj["footTemp"] = $t.import.url("@temp/index/foot").exportVue($t.foot);
                tempObj["AuthorATemp"] = (0, vueSDK_3.Component)($t).import(function (temp) { return temp.init.temp_index_AuthorAnimate; }).exportVue({});
                return tempObj;
            },
            action: function ($t) {
                return {
                    ...
                    */
                    ...
                    saveHomeToHistory: function () {
                        ...
                        vueSDK_3.urlHistory.addJoinApp("toUrlHistoryFuntion()"); //join index of this.toUrlHistoryFuntion()
    ...
    define("src/models/SysConfig_Interface/psylVueTsc", ["require", "exports", "src/models/SysConfig_Interface/ProjectMap/init_View", "src/models/SysConfig_Interface/vueDirectiveEvt", "src/models/vueSDK"], function (require, exports, init_View_2, vueDirectiveEvt_1, vueSDK_4) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
            ...
            function CreateVue(temp) {
                ...
                this.setMetaViewport = function (content) {
                    if (content != null && content != undefined) //setting viewport
                        vueSDK_4.pb.el.tag("head").at(0).name("viewport").at(0).get.setAttribute("content", content);
                    return {
    ...
    define("src/init/main", ["require", "exports", "src/models/vueSDK", "src/models/SysConfig_Interface/psylVueTsc"], function (require, exports, vueSDK_5, psylVueTsc_1) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        ...
        new psylVueTsc_1.default(function (temp) { return temp.view_index; })
            ...
            .getIcon(function ($t) {
            return vueSDK_5.importLoad.pub.lib.src('inlayout.ico');
        })
            .getHeadTitle("init.page", //資料切換觸發 key
        function ($t) {
            return vueSDK_5.importLoad.pub.config.get("title") + "-" + vueSDK_5.importLoad.pub.config.get("page")[$t.init.page];
        }) //html title name
            .load(function ($t) {
            return {
                main: $t //注入共用入口點數據(繼承)
