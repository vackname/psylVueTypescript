...
split_b_obj.c(this,'controllers_index',vToaW5pdA__Model.controllers_index); 
 split_b_obj.c_sID(this,'view_index','inittemp/t3',false,true,function(){ 
...
},'init_view_index','init/c2.css'); 
 split_b_obj.c_sID(this,'temp_index_head','inittemp/t2',false,true,function(){ 
 this.vue=null;split_b_obj.c_JS(this,selfPJ,function(){

},[vToaW5pdA__Model.temp_index_head,''],'','init');
},'init_temp_index_head','init/c1.css'); 
 split_b_obj.c_sID(this,'temp_index_foot','inittemp/t1',false,true,function(){ 
 this.vue=null;split_b_obj.c_JS(this,selfPJ,function(){

},[vToaW5pdA__Model.temp_index_foot,''],'','init');
},'init_temp_index_foot','init/c0.css');
 }; 
...
var PJVueModel = (function () {
    ...
    define("src/init/view/index", ["require", "exports", "src/init/animateModel/author", "src/models/vueSDK"], function (require, exports, author_1, vueSDK_2) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        ...
        exports.default = {
            ...
            completed: function ($t) {
                ...
                //樣版渲染完成
                vueSDK_2.pb.el.id("init_panel").style({ "opacity": "0" }).animate({ "duration": 0.6, "delay": 0.3, "count": 1 }, {
                    "0%": { "opacity": "0.1" },
                    "100%": { "opacity": "1" }
                }).remove();
            ...
            temp: function ($t) {
                /** 樣版緩存 */
                var tempObj = {};
                vueSDK_2.pb.AddPrototype($t.head, { main: $t });
                tempObj["headTemp"] = (0, vueSDK_2.Component)($t).import(function (temp) { return temp.init.temp_index_head; }).exportVue($t.head);
                ...
                return {
                    ...
                    */
                    ...
                    saveHomeToHistory: function () {
                        ...
                        vueSDK_2.urlHistory.addJoinApp("toUrlHistoryFuntion()"); //join index of this.toUrlHistoryFuntion()
    ...
    define("src/init/main", ["require", "exports", "src/models/vueSDK", "src/models/SysConfig_Interface/psylVueTsc"], function (require, exports, vueSDK_3, psylVueTsc_1) {
        "use strict";
        Object.defineProperty(exports, "__esModule", { value: true });
        ...
        new psylVueTsc_1.default(function (temp) { return temp.view_index; })
            ...
            .getIcon(function ($t) {
            return vueSDK_3.importLoad.pub.lib.src('inlayout.ico');
        })
            .getHeadTitle("init.page", //資料切換觸發 key
        function ($t) {
            return vueSDK_3.importLoad.pub.config.get("title") + "-" + vueSDK_3.importLoad.pub.config.get("page")[$t.init.page];
        }) //html title name
            .load(function ($t) {
            return {
                main: $t //注入共用入口點數據(繼承)
